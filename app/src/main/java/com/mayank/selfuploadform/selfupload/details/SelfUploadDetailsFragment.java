...
public class SelfUploadDetailsFragment extends BaseSelfUploadFragment
        ...
        NumberField.NumberFieldInteractionListener, InputField.InputFieldInteractionListener,SelectionField
                .SelectionFieldInteractionListener,SpinnerField.SpinnerFieldInteractionListener {
    ...
    private void initPresenter() {
        ...
        presenter = new SelfUploadDetailsPresenter(repository, this, getListener().getPropertyModel());
    }
